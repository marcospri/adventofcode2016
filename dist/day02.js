...
var _user$project$Main$getPositionNumber = F2(
	function (keyboard, pos) {
		var _p0 = A2(_elm_lang$core$Dict$get, pos, keyboard);
		if (_p0.ctor === 'Just') {
			return _p0._0;
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
				...
				_p0)('Out of bounds on the key pad');
		}
	});
var _user$project$Main$get_ = F2(
	function (i, arr) {
		var _p2 = A2(_elm_lang$core$Array$get, i, arr);
		if (_p2.ctor === 'Just') {
			return _p2._0;
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
...
var _user$project$Main$tail_ = function (l) {
	var _p4 = _elm_lang$core$List$tail(l);
	if (_p4.ctor === 'Just') {
		return _p4._0;
	} else {
		return {ctor: '[]'};
...
var _user$project$Main$getButtonSequence = F2(
	function (model, keyboard) {
		return _elm_lang$core$Array$fromList(
			A2(
				_elm_lang$core$List$map,
				_user$project$Main$getPositionNumber(keyboard),
				_user$project$Main$tail_(
					A3(
						...
						F2(
							function (_p6, _p5) {
								...
								var _p11 = _p8._1;
								var _p10 = _p8._0;
								var _p9 = {ctor: '_Tuple2', _0: _p10 + _p7._0, _1: _p11 + _p7._1};
								var newX = _p9._0;
								var newY = _p9._1;
								return A2(
									_elm_lang$core$Dict$member,
									{ctor: '_Tuple2', _0: newX, _1: newY},
									keyboard) ? {ctor: '_Tuple2', _0: newX, _1: newY} : {ctor: '_Tuple2', _0: _p10, _1: _p11};
							}),
									...
									default:
										return _elm_lang$core$Native_Utils.crashCase(
											'Main',
											{
												...
												end: {line: 153, column: 65}
											},
											_p12)('Invalid character in input');
								}
							},
							A2(
...
var _user$project$Main$getMoves = F2(
	function (keyboard, model) {
		var buttonSequene = A2(_user$project$Main$getButtonSequence, model, keyboard);
		return A2(
			_elm_lang$core$List$map,
			function (p) {
				return A2(_user$project$Main$get_, p - 1, buttonSequene);
			},
			_user$project$Main$tail_(
				A3(
					_elm_lang$core$List$scanl,
...
var _user$project$Main$keyPadPositionsPart2 = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
...
var _user$project$Main$solverPart2 = function (model) {
	return A2(
		_elm_lang$core$String$join,
		'',
		A2(_user$project$Main$getMoves, _user$project$Main$keyPadPositionsPart2, model));
};
var _user$project$Main$keyPadPositionsPart1 = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
...
var _user$project$Main$solverPart1 = function (model) {
	return A2(
		...
		A2(
			...
			A2(_user$project$Main$getMoves, _user$project$Main$keyPadPositionsPart1, model)));
};
var _user$project$Main$init = {
	...
	_0: {
		...
		input: A2(
			...
			'',
			A2(_elm_lang$core$Array$get, 1, _user$project$Inputs$problemInputs)),
		solutionPart1: '',
		solutionPart2: '',
		lastButtonPosition: {ctor: '_Tuple2', _0: 0, _1: 0}
	},
...
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {problemDay: a, input: b, lastButtonPosition: c, solutionPart1: d, solutionPart2: e};
	});
