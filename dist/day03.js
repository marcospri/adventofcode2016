...
var _user$project$Main$listToListOfTriangles = F2(
	function (triangles, l) {
		...
		while (true) {
			...
			if (((_p0.ctor === '::') && (_p0._1.ctor === '::')) && (_p0._1._1.ctor === '::')) {
				...
				triangles = _v1;
				l = _v2;
				continue listToListOfTriangles;
			} else {
				return _elm_lang$core$List$reverse(triangles);
			}
		}
	});
var _user$project$Main$findValidTriangles = function (triangles) {
		...
		A2(
			...
			function (sides) {
				...
				if ((((_p1.ctor === '::') && (_p1._1.ctor === '::')) && (_p1._1._1.ctor === '::')) && (_p1._1._1._1.ctor === '[]')) {
					return (_elm_lang$core$Native_Utils.cmp(_p1._0 + _p1._1._0, _p1._1._1._0) > 0) ? true : false;
				} else {
					return false;
				}
			},
...
var _user$project$Main$solverPart1 = function (model) {
	return _user$project$Main$findValidTriangles(
		A2(
			_elm_lang$core$List$map,
...
var _user$project$Main$solverPart2 = function (model) {
	var listOfNumbers = _elm_lang$core$List$concat(
		A2(
			_elm_lang$core$List$map,
	...
	return _user$project$Main$findValidTriangles(
		A2(
			...
			_elm_lang$core$List$sort,
			A2(
				_user$project$Main$listToListOfTriangles,
				{ctor: '[]'},
				A2(
					_elm_lang$core$List$map,
					function (_p2) {
							...
							function (div) {
								return A2(
									...
									function (_p4) {
										var _p5 = _p4;
										return _elm_lang$core$Native_Utils.eq(
											_p5._0 + A2(_elm_lang$core$Basics_ops['%'], 1, 3),
											div);
									},
									listOfNumbers);
							},
...
var _user$project$Main$init = {
	...
	_0: {
		...
		input: A2(
			...
			'',
			A2(_elm_lang$core$Array$get, 2, _user$project$Inputs$problemInputs)),
		solutionPart1: '',
		solutionPart2: ''
	},
