...
var _user$project$Main$mostCommon = function (dict) {
	return _elm_lang$core$List$reverse(
		A2(
...
var _user$project$Main$counter = function (list) {
	return A3(
		_elm_lang$core$List$foldr,
		F2(
			function (x, dict) {
				var _p2 = A2(_elm_lang$core$Dict$get, x, dict);
				if (_p2.ctor === 'Just') {
					return A3(_elm_lang$core$Dict$insert, x, _p2._0 + 1, dict);
				} else {
					return A3(_elm_lang$core$Dict$insert, x, 1, dict);
				}
			}),
		_elm_lang$core$Dict$empty,
		list);
};
var _user$project$Main$getMessageLetters = function (model) {
	return A2(
...
var _user$project$Main$sentenceLength = 8;
var _user$project$Main$getLettersColumns = F2(
	function (messageLetters, model) {
		return A2(
			_elm_lang$core$List$map,
			function (div) {
				return A2(
					...
					A2(
						...
						function (_p5) {
							var _p6 = _p5;
							return _elm_lang$core$Native_Utils.eq(
								A2(_elm_lang$core$Basics_ops['%'], _p6._0, _user$project$Main$sentenceLength),
								div);
						},
						messageLetters));
			},
			A2(_elm_lang$core$List$range, 0, _user$project$Main$sentenceLength - 1));
	});
var _user$project$Main$solverPart1 = function (model) {
	var messageLetters = _user$project$Main$getMessageLetters(model);
	return A2(
		_elm_lang$core$String$join,
		'',
		A2(
			...
			A2(
				...
				A2(
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$Main$mostCommon,
						A2(
							_elm_lang$core$List$map,
							_user$project$Main$counter,
							A2(_user$project$Main$getLettersColumns, messageLetters, model)))))));
};
...
var _user$project$Main$problemDay = 6;
