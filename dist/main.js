...
var _user$project$Main$renderProblem = F2(
	function (total, index) {
		var day = _elm_lang$core$Basics$toString((25 - (25 - total)) - index);
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
									...
									},
									{
										...
										_0: A2(
											...
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(
													A2(_elm_lang$core$Basics_ops['++'], 'Day: ', day)),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
														...
														_elm_lang$html$Html$a,
														{
															...
															_0: _elm_lang$html$Html_Attributes$href(
																A2(
																	_elm_lang$core$Basics_ops['++'],
																	'day',
																	A2(_elm_lang$core$Basics_ops['++'], day, '.html'))),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('[Go to solver]'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: _user$project$View$renderGithubLink(day),
														_1: {ctor: '[]'}
													}
												}),
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _user$project$View$renderProblemLink(day),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
...
var _user$project$Main$view = function (model) {
	var problems = A2(
		_elm_lang$core$List$map,
		_user$project$Main$renderProblem(model),
		A2(
			_elm_lang$core$List$range,
			0,
			A3(
				...
				A2(
					...
					'ey',
					_elm_lang$core$Array$length(_user$project$Inputs$problemInputs)))));
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Advent of Code 2016 '),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$small,
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Solved in Elm'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
...
var _user$project$Main$main = _elm_lang$html$Html$beginnerProgram(
	{
		model: _elm_lang$core$Array$length(_user$project$Inputs$problemInputs),
...
if (typeof _user$project$Inputs$main !== 'undefined') {
    _user$project$Inputs$main(Elm['Inputs'], 'Inputs', undefined);
}
Elm['Main'] = Elm['Main'] || {};
